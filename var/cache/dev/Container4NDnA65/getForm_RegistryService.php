...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\BookingType' => function () {
    return ($this->privates['App\Form\BookingType'] ?? $this->privates['App\Form\BookingType'] = new \App\Form\BookingType());
